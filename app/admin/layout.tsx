...
export default function AdminLayout({
  ...
  useEffect(() => {
    const fetchNotificationStats = async () => {
      try {
        ...
        const response = await fetch(getApiUrl("/api/admin/notifications/stats"), {
    ...
    if (user && isSuperAdmin) {
      ...
      const interval = setInterval(fetchNotificationStats, 180000);
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Desktop sidebar */}
      <div className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0 lg:pt-20 z-20">
