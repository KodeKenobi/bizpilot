          ...
          <div className="p-6">
            <div className="text-center space-y-4">
              ...
              <button
                ...
                className="w-full max-w-xs mx-auto bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-3 px-6 rounded-lg font-medium hover:from-cyan-600 hover:to-blue-600 transition-all duration-200 flex items-center justify-center gap-2"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
