...
export const HtmlToPdfTool: React.FC<HtmlToPdfToolProps> = ({
  ...
  const handleConversion = async () => {
    if (!uploadedFile) {
      setResult({
        type: "error",
        message: "Please upload an HTML file to convert",
      });
      return;
    }
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:5000/convert_html_to_pdf",
        {
          method: "POST",
          body: formData,
        }
      ...
      setResult({
        type: "error",
        message: "Error converting HTML to PDF. Please try again.",
      });
    } finally {
        ...
        <div className="p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-400 text-sm">
              Upload an HTML file to convert it to PDF
            </p>
          </div>
          <FileUpload
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-400 text-sm mb-4">
                This will convert your HTML file to PDF format
              </p>
            </div>
        ...
        <div className="mt-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl overflow-hidden">
          ...
          <div className="p-6">
            <div className="text-center">
              <p className="text-gray-400 text-sm mb-4">
                Your HTML file has been converted to PDF format
              </p>
            </div>
          </div>
        </div>
